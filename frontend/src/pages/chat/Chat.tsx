                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Aimbridge Copilot</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Welcome to Aimbridge chatbot which is configured to answer your questions</h2>
                            </Stack>
                        ) : (
